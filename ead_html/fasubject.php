...
$result = mysql_query("select subjects.subjectTerm,resources.title from resources, archdescriptionsubjects, subjects where subjects.subjectId=archdescriptionsubjects.subjectId and archdescriptionsubjects.resourceId=resources.resourceId and subjects.subjectTerm like '%$term%' order by $order"); 
